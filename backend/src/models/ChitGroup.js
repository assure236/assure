...
const chitGroupSchema = new mongoose.Schema({
  ...
  fdr_certificate_url: { type: String, default: '' },
  pso_certificate_url: { type: String, default: '' },
  draft_agreement_url: { type: String, default: '' },
  signed_agreement_url: { type: String, default: '' },
  ...
  was_full: { type: Boolean, default: false },
  description: String,
